...
// ─── Collapsible Section (mobile helper) ─────────────────────────────────────
...
export default function FaviconGenerator() {
  ...
  const [snippetFramework, setSnippetFramework] =
    useState<SnippetFramework>("html");
...
export default function RootLayout({
  ...
  // Modern React snippet — no react-helmet, uses useEffect + document.head
  const reactSnippet = `// src/hooks/useFavicon.ts
...
export function useFavicon({
  ...
  useEffect(() => {
    ...
    setLink("icon", favicon32, "32x32", "image/png");
    setLink("icon", favicon16, "16x16", "image/png");
    setLink("apple-touch-icon", appleTouchIcon, "180x180");
    setLink("manifest", manifestHref);
    setMeta("theme-color", themeColor);
  }, [favicon32, favicon16, appleTouchIcon, themeColor, manifestHref]);
}
...
//   useFavicon({ themeColor: "${config.bgColor}" });
//   return <YourApp />;
// }`;
...
`
  ...
  return (
    <TooltipProvider>
       ...
       * lg+: two columns — left (preview + snippet + download + history),
       *      right (controls).
       */}
      <div className="flex flex-col gap-5 lg:grid lg:grid-cols-[1fr_360px]">
        ...
        <div className="order-1 flex flex-col gap-4 lg:order-2">
          ...
          {/* Shape & Style */}
          <CollapsibleSection title="Shape & Style" defaultOpen>
            <div className="mb-4">
        ...
        {/* ── Preview + output column (shows second on mobile) ── */}
            ...
            <div className="p-4 sm:p-6">
              ...
              >
                ...
                >
                  ...
                  />
                  <div
                    className={`flex min-w-0 flex-1 items-center gap-2 rounded-md px-3 py-1.5 ${
          ...
          <Card className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-100 px-5 py-4">
              ...
              <Button
                ...
                size="sm"
                onClick={handleCopy}
                className="ml-3 flex-shrink-0 rounded-full border-zinc-200 text-xs font-medium"
              >
                {copied ? (
                  <span className="flex items-center gap-1.5">
                    <Check
            ...
            {/* Framework tabs */}
            <div className="flex gap-1 border-b border-zinc-100 px-4 py-3 sm:px-5">
              {(
                [
            ...
            {/* Context hint */}
            <div className="border-b border-zinc-100 bg-zinc-50 px-4 py-2.5 sm:px-5">
              ...
              {snippetFramework === "react" && (
                <p className="text-xs text-zinc-400">
                  ...
                  hook into your project — no extra packages needed.
                </p>
              )}
            </div>

            <div className="p-4 sm:p-5">
              <pre className="overflow-x-auto rounded-xl bg-zinc-950 p-3 text-xs leading-relaxed text-zinc-300 sm:p-4">
          ...
          >
            {downloading ? (
              ...
              <span className="flex flex-wrap items-center justify-center gap-2">
                ...
                <Badge
                  variant="secondary"
                  className="rounded-full bg-white/10 px-2 py-0 text-[10px] font-medium text-white/80"
                >
                  8 PNG + ICO + HTML
                </Badge>
              </span>
